...
const cacheName = 'finalProjectA1-2020-05-01 15:45:48.282712'; // unique value, generated each deploy
const contentToCache = [
  'index.html',
  'code.js',
  'properties/golfHoleCropped.png',
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'finalProjectA1'.length) === 'finalProjectA1') {
